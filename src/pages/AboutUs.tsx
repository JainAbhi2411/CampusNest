      ...
      <div className="min-h-screen">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              <AnimatedText
                ...
                type="fade-up"
              />
              <p className="text-lg xl:text-xl text-primary-foreground/90 animate-fade-in-delay">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 xl:gap-6">
              {stats.map((stat, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="text-center shadow-card hover:shadow-3xl transition-smooth-slow card-3d"
                  ...
                  >
                    <CardContent className="p-4 xl:p-6">
                      ...
                      <div className="text-xs xl:text-base text-muted-foreground">{stat.label}</div>
                    </CardContent>
                  </Card>
                );
              })}
          ...
          <section className="py-16 xl:py-24 bg-muted/30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-3xl mx-auto text-center mb-12">
                <h2 className="text-3xl xl:text-4xl font-bold mb-6">Our Story</h2>
        ...
        <section className="py-16 xl:py-24 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl xl:text-4xl font-bold mb-4">What Drives Us</h2>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 xl:gap-8">
              {values.map((value, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="shadow-card hover:shadow-3xl transition-smooth-slow group"
                  >
                    <CardContent className="p-6 xl:p-8">
                      <div className="flex items-start gap-3 xl:gap-4">
                        <div className="flex-shrink-0">
                          <div className="inline-flex items-center justify-center w-12 h-12 xl:w-16 xl:h-16 rounded-full bg-secondary/10 group-hover:bg-secondary/20 transition-smooth">
                            <Icon className="h-6 w-6 xl:h-8 xl:w-8 text-secondary group-hover:animate-scale-pulse" />
                          </div>
                        </div>
                        <div className="flex-1">
                          <h3 className="text-lg xl:text-2xl font-bold mb-2 xl:mb-3">{value.title}</h3>
                          <p className="text-sm xl:text-lg text-muted-foreground">{value.description}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        <ParallaxSection speed={0.3}>
          <section className="py-16 xl:py-24 bg-muted/30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl xl:text-4xl font-bold mb-4">Our Journey</h2>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="max-w-4xl mx-auto">
                <div className="space-y-6 xl:space-y-8">
                  {milestones.map((milestone, index) => (
                    ...
                    >
                      <div className="flex-shrink-0 w-16 xl:w-24 text-right">
                      ...
                      <div className="flex-1 pb-6 xl:pb-8 border-l-2 border-border pl-4 xl:pl-6 relative">
                        <div className="absolute left-0 top-2 w-3 h-3 xl:w-4 xl:h-4 rounded-full bg-secondary -translate-x-[7px] xl:-translate-x-[9px] group-hover:scale-150 transition-transform" />
                        <h3 className="text-base xl:text-xl font-bold mb-1 xl:mb-2">{milestone.title}</h3>
                        <p className="text-sm xl:text-base text-muted-foreground">{milestone.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <section className="py-16 xl:py-24 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl xl:text-4xl font-bold mb-4">Meet Our Team</h2>
              <p className="text-muted-foreground text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
              {team.map((member, index) => (
                <Card
                  key={index}
                  className="shadow-card hover:shadow-3xl transition-smooth-slow card-3d overflow-hidden"
                >
        ...
        {/* CTA Section */}
        <section className="py-12 xl:py-24 bg-primary text-primary-foreground">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a
              href="/properties"
              className="inline-flex items-center justify-center px-6 xl:px-8 py-3 rounded-lg bg-secondary text-secondary-foreground font-semibold hover:bg-secondary/90 transition-smooth min-h-[48px] text-sm xl:text-base"
            >
